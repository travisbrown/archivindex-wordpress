...
//! their identifiers are redirected to the retained record. Its declared filename is updated to the
//! output basename.
...
pub struct CombineOptions {
    ...
    /// Filename prefix before a hyphen, such as `example.com`. Matches all sessions with that
    /// prefix, including longer names such as `example.com-blog`.
