...
//!
//! The first argument is an output directory, which must be empty or absent. Each remaining
//! argument is a WARC file or a directory searched recursively for WARC files. Sources are sampled
//! independently so one corpus cannot crowd out the others.
