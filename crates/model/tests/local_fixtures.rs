//! Validate local response fixtures under `examples/data/local/`.
//!
//! The test skips validation when that directory is absent. An existing but empty fixture directory
//! fails the test.

use std::collections::BTreeMap;
use std::path::Path;

use archivindex_wordpress_model::api::discovery::{
    ApiRoot, ErrorResponse, Namespace, Taxonomy, Type,
};
use archivindex_wordpress_model::api::media::Media;
use archivindex_wordpress_model::api::resource::{Category, Comment, Page, Post, Tag, User};
